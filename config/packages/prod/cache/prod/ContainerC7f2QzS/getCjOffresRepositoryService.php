...
// Returns the private 'App\Repository\CjOffresRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CjOffresRepository.php';

return $this->privates['App\Repository\CjOffresRepository'] = new \App\Repository\CjOffresRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
