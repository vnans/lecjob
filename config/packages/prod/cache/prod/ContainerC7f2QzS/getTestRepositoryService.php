...
// Returns the private 'App\Repository\Customer\testRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/Customer/testRepository.php';

return $this->privates['App\Repository\Customer\testRepository'] = new \App\Repository\Customer\testRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
