...
// Returns the private 'App\Repository\Customer\UserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/Customer/UserRepository.php';

return $this->privates['App\Repository\Customer\UserRepository'] = new \App\Repository\Customer\UserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
