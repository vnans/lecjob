...
// Returns the private 'App\Repository\ChefRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ChefRepository.php';

return $this->privates['App\Repository\ChefRepository'] = new \App\Repository\ChefRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
