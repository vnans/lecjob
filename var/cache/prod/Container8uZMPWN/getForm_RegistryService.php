...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CjOffresType' => function () {
    return ($this->privates['App\Form\CjOffresType'] ?? $this->privates['App\Form\CjOffresType'] = new \App\Form\CjOffresType());
